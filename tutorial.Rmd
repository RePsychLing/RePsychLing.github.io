...
data.frame(day = "Monday",  time = "08:00-09:00", event = "Breakfast") %>%
    ...
    add_row(day = "Monday", time = "09:00-10:30", 
            event = "Douglas Bates: [Introduction](intro.html)") %>%
    ...
    add_row(day = "Wednesday", time = "09:00-10:30", 
            event = "Benedikt Ehinger / Dave Kleinschmidt: Mixed-model timeseries analysis\n\nHannes Matuschek: Prewhitening of LMMs") %>%
    ...
    add_row(day = "Tuesday",  time = "11:00-12:30", event = "Dave Kleinschmidt: Formulas\n\nBayoan Calderon: Setup of a Julia Project") %>%
